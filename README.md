[![Run App SandeshSubedi](https://github.com/Sandesh-Subedi/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Sandesh-Subedi/GithubActions/actions/workflows/run-app.yaml)
